...
//Sort the names of employee and show the employee names
// employeesData = employeesData.filter(employee => employee.FIRST_NAME != undefined || employee.LAST_NAME != undefined );
// employeesData = employeesData.filter(employee => (typeof employee.FIRST_NAME).startsWith("string") || (typeof employee.LAST_NAME).startsWith("string"));

// console.log(employeesData);
// let names = employeesData.map(employee => employee.FIRST_NAME + " " + employee.LAST_NAME);
// console.log(names.sort());

let employeesName =[];

function showingNames(employeesData){
    employeesData.forEach(employee => {
        if(employee.FIRST_NAME != undefined){
           if((typeof employee.FIRST_NAME).startsWith("string")) {
           employeesName.push(employee.FIRST_NAME);
          }
        }
        if(employee.LAST_NAME!= undefined){
            if((typeof employee.LAST_NAME).startsWith("string")) {
            employeesName.map(employeeFirstName => employeeFirstName + " " + employee.LAST_NAME);
           }
         }
        
    });
}
showingNames(employeesData);
